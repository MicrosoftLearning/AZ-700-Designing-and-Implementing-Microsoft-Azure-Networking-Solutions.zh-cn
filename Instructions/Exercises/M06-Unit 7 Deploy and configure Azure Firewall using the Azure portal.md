...
1. 在“子网用途”下拉列表中选择“Azure 防火墙”。******** 

1. 将“起始地址”更改为 10.0.1.0/26********。
...
1. 在 Cloud Shell 窗格的工具栏中，选择“**管理文件**”图标，在下拉菜单中选择“**上传**”，将 **firewall.json** 和 **firewall.parameters.json** 文件上传到 Cloud Shell 主目录。
...
1. 在“**fw-test-pol**”页的“**规则**”下，选择“**网络规则**”。
...
1. 在“**fw-test-pol**”页的“**规则**”下，选择“**DNAT 规则**”。
