...
1. 在“名称”中，输入 Spoke-01。

1. 在“区域”中，选择你的区域。

1. 在完成时选择“下一步:IP 地址”。

1. 在“IPv4 地址空间”中，输入“10.0.0.0/16”。

1. 删除此处列出的任何其他地址空间，例如 10.1.0.0/16。

1. 在“子网名称”下，选择词语“默认”。

1. 在“编辑子网”对话框中，将名称更改为“Workload-01-SN”。

1. 将“子网地址范围”更改为“10.0.1.0/24”。
...
1. 在搜索框中，输入“防火墙管理器”，然后在出现“防火墙管理器”时选择它。

1. 在“防火墙管理器”页上，从概述页面选择“查看安全虚拟中心” 。

1. 在“虚拟中心”页上，选择“创建新的安全虚拟中心”。

1. 对于**资源组**，请选择 **fw-manager-rg**。

1. 在“区域”中，选择你的区域。

1. 在“安全虚拟中心名称”中，输入 Hub-01 。

1. 在“中心地址空间”中，输入“10.2.0.0/16”。

1. 选择“新建 vWAN”。

1. 在“虚拟 WAN 名称”中，输入“Vwan-01”。

1. 在完成时选择“下一步:Azure 防火墙”。
...
1. 记下公共 IP 地址（例如 **51.143.226.18**），稍后将使用它。
...
1. 重复上面的步骤 4 到步骤 9，以创建另一个类似的连接，但使用 hub-spoke-02 的连接名称连接到 Spoke-02 虚拟网络。
...
1. 在 Cloud Shell 窗格的工具栏中，选择“**管理文件**”图标，在下拉菜单中选择“**上传**”，将 **FirewallManager.json** 和 **FirewallManager.parameters.json** 文件从源文件夹 **F:\Allfiles\Exercises\M06** 逐个上传到 Cloud Shell 主目录。
