...
重复上述步骤 1 到 14，创建另一个类似的虚拟网络和子网，但使用以下信息。 无需等待第一个虚拟网络完成部署。 
...
1. 刷新**** 虚拟网络连接页，确认拥有两个虚拟网络，即 Spoke-01 和 Spoke-02。
...
1. 在 Srv-workload-02 的“概述”页上，在右侧窗格的“网络”部分下，记下“专用 IP 地址”（例如“10.1.0.4”）。********************
